    ...
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
      <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
        ...
        <div className='md:w-1/2 space-y-8 h-full'> 
            ...
            <p className='md:w-4/5'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illum quam neque 
                dicta nobis, labore quibusdam ut ea, distinctio quis beatae repellat doloribus
                 quia tempore asperiores quasi architecto ipsam optio. Iste?</p>
                 <div>
